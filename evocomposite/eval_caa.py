...
from evocomposite.composite_adv.attacks import *
from evocomposite.composite_adv.utilities import make_dataloader, EvalModel
from math import pi
...
def main_worker(gpu, args):
    ...
    # CIFAR100
    # model.load_state_dict(torch.load(
    #     '/mnt/jfs/sunjialiang/AAAD/retrain/standard_train/trained_model_100/PreActResNet50-20240130-202940/weights.pt'))
    # model.load_state_dict(torch.load(
    #     '/mnt/jfs/sunjialiang/AAAD/retrain/standard_train/trained_model_100/GoogLeNet-20230327-141143/weights.pt'))
    # model.load_state_dict(torch.load('/mnt/jfs/sunjialiang/AAAD/retrain/standard_train/trained_model_100/DenseNet121-20230327-132159/weights.pt'))
    # model.load_state_dict(torch.load(
    #     '/mnt/jfs/sunjialiang/AAAD/retrain/standard_train/trained_model_100/WideResNet50-20240201-142748/weights.pt'))
    # model.load_state_dict(torch.load(
    #     '/mnt/jfs/sunjialiang/AAAD/retrain/standard_train/trained_model_100/VGG-20240201-170204/weights.pt'))
    ...
    # model.load_state_dict(torch.load('/mnt/jfs/sunjialiang/AAAD/retrain/CAA_AT/PreActResNet50-f/model-epoch109.pt'))
    # model.load_state_dict(torch.load('/mnt/jfs/sunjialiang/AAAD/retrain/CAA_AT/WideResNet50-f/model-epoch49.pt'))
    ...
    # "CompositeAttack(model, enabled_attack=(2,), order_schedule='fixed', inner_iter_num=2)" ]
    ...
    # "CompositeAttack(model, enabled_attack=(4,), order_schedule='scheduled', inner_iter_num=20)" ]
    ...
    # "CompositeAttack(model, enabled_attack=(0,1,2,3,4), order_schedule='fixed', inner_iter_num=1)" ]
    #                            "CompositeAttack(model, enabled_attack=(1,0,2,0,1,1), order_schedule='fixed', inner_iter_num=1)"]
    #     "CompositeAttack(model, enabled_attack=(2,1,0,1,4,2,3,), order_schedule='fixed', inner_iter_num=1)"]
        "CompositeAttack(model, enabled_attack=(2,1,0,1,4,2,3), order_schedule='fixed', inner_iter_num=1)"]
